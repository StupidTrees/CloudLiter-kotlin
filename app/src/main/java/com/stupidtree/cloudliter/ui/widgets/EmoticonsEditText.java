...
import static com.stupidtree.cloudliter.ui.widgets.EmoticonsTextView.buildPattern;
    ...
    private CharSequence replace(String text) {
        try {
            ...
            while (matcher.find()) {
                ...
                Bitmap bitmap = ImageUtils.getBitmapFromDrawable(getContext(), imageId,getTextSize()*1.3f);
